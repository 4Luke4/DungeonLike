...
> **Status: pre-alpha.** This repository currently contains the project foundation
> — governance, legal, tooling, and automation. Application code has not landed yet.
...
| Workflow | Purpose |
| -------- | ------- |
| `ci.yml` | Linting, repository invariants, commit-message conventions |
| `android.yml` | Gradle build and tests — inert until a Gradle project exists |
